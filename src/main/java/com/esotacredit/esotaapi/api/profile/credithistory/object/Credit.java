package com.esotacredit.esotaapi.api.profile.credithistory.object;
...
public class Credit {
    ...
    public Credit(int id, String purchaseTransactionId, String joiningTime, String creditedTime, String creditedAmount) {
        Id = id;
